...
data Suspension s i o = Suspension
  { sIntMap  :: IntMap (Request (FSReq, i, s) FSResp (SM s i o))
  , sCounter :: Int
  }
...
addSuspension :: Suspension s i o -> Request (FSReq, i, s) FSResp (SM s i o) -> (Int, Suspension s i o)
addSuspension (Suspension intMap counter) req =
  (counter, Suspension (M.insert counter req intMap) (counter + 1))

resumeSuspension :: Suspension s i o -> Int -> (Request (FSReq, i, s) FSResp (SM s i o), Suspension s i o)
